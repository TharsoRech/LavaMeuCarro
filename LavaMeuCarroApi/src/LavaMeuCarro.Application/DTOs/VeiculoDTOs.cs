...
public record VehicleAppointmentDTO(int Id, DateTime ScheduledAt, int Status, string ServiceName, string ProfessionalName, decimal TotalPrice, int DurationMinutes);
