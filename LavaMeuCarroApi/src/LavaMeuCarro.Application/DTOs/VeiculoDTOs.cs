...
public record VehicleAppointmentDTO(int Id, string ScheduledAt, string Status, string? ServiceName, string? ProfessionalName, decimal TotalPrice, int DurationMinutes);
