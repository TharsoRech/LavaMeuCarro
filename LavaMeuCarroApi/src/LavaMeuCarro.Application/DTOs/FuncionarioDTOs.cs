...
public record UpdateFuncionarioRequest(string? Name, string? Doc, string? Specialty, string? Bio, bool? Active, string? AvailableTimes, bool? IsAdmin, string? Base64Image, List<int>? ServiceIds);
