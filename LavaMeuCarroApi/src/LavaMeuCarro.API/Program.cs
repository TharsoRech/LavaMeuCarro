...
// JWT Authentication
var jwtSecret = builder.Configuration["Jwt:Secret"] ?? "LavaMeuCarroSuperSecretKey2024!@#$%^&*()";
...
builder.Services.AddControllers().AddJsonOptions(options =>
{
    ...
    options.JsonSerializerOptions.PropertyNameCaseInsensitive = true; // Accept both camelCase and PascalCase from frontend
});
builder.Services.AddEndpointsApiExplorer();
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Lava Meu Carro API", Version = "v1" });
