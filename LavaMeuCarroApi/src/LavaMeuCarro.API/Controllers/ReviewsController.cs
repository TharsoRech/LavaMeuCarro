...
using HoraDaBeleza.Application.Commands.Review.CreateAppointmentFeedbackCommand;
    ...
    IMediator mediator) : ApiController
{
    ...
    /// <summary>Submit salon and professional feedback for the same completed appointment</summary>
    [HttpPost("appointment-feedback")]
    [Authorize]
    [ProducesResponseType(201)]
    [ProducesResponseType(422)]
    public async Task<IActionResult> CreateAppointmentFeedback([FromBody] CreateAppointmentFeedbackRequest request)
    {
        var result = await mediator.Send(new CreateAppointmentFeedbackCommand(
        ...
        return StatusCode(201, result.Reviews);
    }
}
